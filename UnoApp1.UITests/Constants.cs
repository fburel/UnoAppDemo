...
public class Constants
{
    ...
    public readonly static string iOSAppName = "com.companyname.CarreraConnect.Uno";
    public readonly static string AndroidAppName = "com.companyname.CarreraConnect.Uno";
