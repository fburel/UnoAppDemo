...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "Unoapp1.dll";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
	...
	setenv ("MONO_GC_PARAMS", "soft-heap-limit=512m,nursery-size=64m,evacuation-threshold=66,major=marksweep,concurrent-sweep", 1);
